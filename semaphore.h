 ...
 * always fail; (FIXME: identify them; also note that symbols
 * PTW32_DLLPORT and PTW32_CDECL pollute user namespace; they
 * should be renamed or eliminated, as noted in <_ptw32.h>).
 */
